    ...
    <div className="p-8 space-y-6 max-w-4xl">
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-1">Tus mesociclos y sesiones de entrenamiento</p>
        </div>
        <Link href="/coach/planning/new">
      ...
      {mesocycles.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-24 text-center">
          ...
          <p className="text-muted-foreground">No tienes mesociclos creados aún.</p>
          <Link href="/coach/planning/new" className="mt-4">
