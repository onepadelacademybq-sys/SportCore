...
export const metadata: Metadata = { title: 'Editar Macrociclo — Entrenador' }

interface PageProps {
  params: Promise<{ id: string }>
}

export default async function CoachEditMacrocyclePage({ params }: PageProps) {
