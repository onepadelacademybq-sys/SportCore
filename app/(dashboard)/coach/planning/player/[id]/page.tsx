...
export const metadata: Metadata = { title: 'Planificación Jugador — Entrenador' }

interface PageProps {
  params: Promise<{ id: string }>
}

export default async function CoachPlayerPlanningPage({ params }: PageProps) {
  ...
  return (
    <div className="p-8 space-y-6 max-w-4xl">
      ...
      <div className="flex flex-wrap items-start justify-between gap-4">
        ...
        <Link href={`/coach/planning/new?playerId=${playerId}`}>
      ...
      {mesocycles.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-20 text-center border border-dashed border-border rounded-xl">
          ...
          <Link href={`/coach/planning/new?playerId=${playerId}`} className="mt-4">
